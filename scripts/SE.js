SE = {
  ...
  ShowTokens: function() {
	...
	ShowMarketView: function(symbol, account) {
		...
		let tasks = [];
		tasks.push(ssc.find('market', 'buyBook', { symbol: symbol }, 200, 0, [{ index: 'priceInt', descending: true }], false));
		tasks.push(ssc.find('market', 'sellBook', { symbol: symbol }, 200, 0, [{ index: 'priceInt', descending: false }], false));
